...
function assertIsGetter(obj, prop) {
  ...
  equal(
    typeof desc.get,
    "function",
    `Getter function exists for property ${prop}`
  );
  equal(
    typeof desc.set,
    "function",
    `Setter function exists for property ${prop}`
  );
...
add_task(async function () {
  ...
  ChromeUtils.defineModuleGetter(obj, "meh", "resource://test/TestFile.jsm");
