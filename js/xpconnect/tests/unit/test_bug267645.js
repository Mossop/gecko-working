...
function run_test() {
  ...
  let threw = Cu.evalInSandbox(
    "var threw; try { func(); threw = false; } catch (e) { globalThis.exn = e; threw = true } threw",
    sb,
    "",
    "FakeFile"
  );
  ...
  threw = Cu.evalInSandbox(
    "var threw; try { func2(); threw = false; } catch (e) { globalThis.exn = e; threw = true } threw",
    sb,
    "",
    "FakeFile"
  );
  ...
  threw = Cu.evalInSandbox(
    "var threw; try { func3(); threw = false; } catch (e) { globalThis.exn = e; threw = true } threw",
    sb,
    "",
    "FakeFile"
  );
  ...
  threw = Cu.evalInSandbox(
    "var threw; try { func4(); threw = false; } catch (e) { globalThis.exn = e; threw = true } threw",
    sb,
    "",
    "FakeFile"
  );
