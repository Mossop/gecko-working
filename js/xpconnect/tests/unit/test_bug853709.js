...
function checkDefineThrows(sb, obj, prop, desc) {
  var result = Cu.evalInSandbox(
    "(function() { try { Object.defineProperty(" +
      ...
      '", ' +
      desc.toSource() +
      '); return "nothrow"; } catch (e) { return e.toString(); }})();',
    sb
  );
...
function run_test() {
  ...
  checkDefineThrows(contentSB, "chromeObj", "a", {
    get: function () {
      return 2;
    },
  });
  ...
  checkDefineThrows(contentSB, "chromeObj", "b", {
    configurable: true,
    get: function () {
      return 2;
    },
  ...
  checkDefineThrows(contentSB, "chromeArr", "1", {
    configurable: true,
    get: function () {
      return 2;
    },
